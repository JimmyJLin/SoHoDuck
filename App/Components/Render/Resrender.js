          ...
          <View style={styles.imgContainer}>
            <Swiper style={styles.wrapper}
              ...
              <View style={styles.slide}>
                <Image style={styles.image} source={{uri: this.props.resinfo.Image}} >
              ...
              <View style={styles.slide}>
                <Image style={styles.image} source={{uri: this.props.resinfo.Image2}} >
                <Text style={styles.imageText}>
                {this.props.resinfo.Name}
                </Text>
                </Image>
              ...
              <View style={styles.slide}>
                <Image style={styles.image} source={{uri: this.props.resinfo.Image3}} >
                <Text style={styles.imageText}>
                {this.props.resinfo.Name}
                </Text>
                </Image>
          ...
          <ScrollView>
            ...
            <TouchableOpacity onPress={() => Communications.phonecall(this.props.resinfo.Phone.replace(/-/g,""), true)}>
              <View style={styles.holder}>
                ...
                <Text style={styles.text}>Call  {this.props.resinfo.Phone}</Text>
              </View>
            </TouchableOpacity>
            </View>
            ...
            <View style={styles.listBox}>
            <TouchableOpacity onPress={() => Communications.web(this.props.resinfo.Website)}>
              <View style={styles.holder}>
                <Image style={styles.icon}
                source={require('../img/render/web.jpg')}/>
                <Text style={styles.text}> {this.props.resinfo.Website}</Text>
              </View>
            </TouchableOpacity>
            </View>
            ...
            <View  style={styles.bigListBox}>
              ...
              {this.props.resinfo.Description}</Text>
            </View>
            </View>
